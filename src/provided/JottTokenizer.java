        ...
        for (int i = 0; i < line.length(); i++) {
          ...
          if (tokenChar == '\"') {
            ...
            for (; i < line.length(); i++) {
              ...
              if (tokenChar == '\"') {
                break; // found the end
              } else if (Character.isDigit(tokenChar) || Character.isLetter(tokenChar)
                  || Character.isWhitespace(tokenChar)) {
                tokenStr += tokenChar;
              } else {
          ...
          switch (tokenChar) {
            ...
            default:
              // Handle errors
              System.err.println("Syntax Error:");
              System.err.println("Invalid token \"" + tokenChar + "\"." + " Unknown character.");
              System.err.println(filename + ":" + lineNum);
              return null;
          }
        }
